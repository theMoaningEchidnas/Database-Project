...
namespace AnimaniaConsole.Core.Commands
{
    public class EditPostPriceCommand : ICommand
    {
        ...
        public EditPostPriceCommand(IPostService postService, IAnimaniaConsoleContext context, UserSessionModel session, IUserService userService)
        {
        ...
        public string Execute(IList<string> parameters)
        {
            ...
            var newPrice = decimal.Parse(parameters[2]);
            ...
            var result = postService.EditPostPrice(editPostModel);
            return result;
        }
    }
}
